...
| `laundry-game-ui.cjs` | 실제 브라우저에서 전용 홈·관리 센터 전환, 모드 선택, 오염 청소, 고장·정전·세제 대응, 체크포인트 복구, 결과→홈 이동, 모바일 354px 홈 버튼·설정 진입과 탭 전환 무재페이드·390/360px 보드 비율·0px 기계–도구 간격·분리된 헤더 설비와 안내·3×2 도구판·고정 탐색 |
